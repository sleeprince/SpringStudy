...
<body>
    <div class="container mt-3">
        ...
        <form action="/v2/edit" method="post">
            ...
            <div class="d-grid gap-2 d-md-flex justify-content-md-end">
                ...
                <c:if test="${dto.accept == true}">
                    <a class="btn btn-warning btn-min-size" href="/v2/detail?no=${dto.no}&type=0">미승인</a>
                </c:if>
                <a class="btn btn-secondary btn-min-size" href="/v2/list">취소</a>
            </div>
        </form>
    </div>
</body>
