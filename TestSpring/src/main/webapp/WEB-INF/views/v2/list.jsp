...
<body>
    <div class="container mt-3">
        ...
        <div class="d-grid gap-2 d-md-flex justify-content-md-end">
            <a href="/v2/list" class="btn btn-secondary">전체</a>
            <a href="/v2/list?type=1" class="btn btn-success">승인</a>
            <a href="/v2/list?type=0" class="btn btn-warning">미승인</a>
            <a href="/v2/new" class="btn btn-primary">추가</a>
        </div>
